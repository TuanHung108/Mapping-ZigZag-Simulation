...
module memory_access_counter (
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n || start_accept) begin
            ...
            l1_input_to_pe_beats            <= l1_input_to_pe_beats + 32'd1;
            l1_weight_to_pe_beats           <= l1_weight_to_pe_beats + 32'd1;
            pe_to_reg_o_writes              <= pe_to_reg_o_writes + 32'd64;
            ...
            if (t2 == 4'd15) begin
                ...
                reg_o_to_l1_output_beats    <= reg_o_to_l1_output_beats + 32'd1;
            end
        end
    end
endmodule
